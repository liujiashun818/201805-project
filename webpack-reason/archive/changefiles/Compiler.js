...
class Compiler extends Tapable {
	...
	run(callback) {
		...
		const onCompiled = (err, compilation) => {
			...
			console.log('Compiler:should-emit');
			...
			this.emitAssets(compilation, err => {
				...
				if (compilation.hooks.needAdditionalPass.call()) {
					...
					this.hooks.done.callAsync(stats, err => {
						if (err) return callback(err);
						console.log('Compiler:additional-pass');
		...
		console.log('Compiler:before-run');
	...
	emitAssets(compilation, callback) {
		...
		const emitFiles = err => {
			...
			asyncLib.forEach(
				...
				err => {
					if (err) return callback(err);
					console.log('Compiler:after-emit');
	...
	newCompilation(params) {
		...
		console.log('Compiler:this-compilation');
	...
	createContextModuleFactory() {
		...
		console.log('Compiler:context-module-factory');
	...
	compile(callback) {
		...
		console.log('Compiler:before-compile');
		this.hooks.beforeCompile.callAsync(params, err => {
			...
			this.hooks.make.callAsync(compilation, err => {
				...
				compilation.seal(err => {
					if (err) return callback(err);
					console.log('Compiler:after-compile');
