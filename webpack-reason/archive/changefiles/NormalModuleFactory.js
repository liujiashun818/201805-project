...
class NormalModuleFactory extends Tapable {
	constructor(context, resolverFactory, options) {
		...
		this.hooks.factory.tap("NormalModuleFactory",() => (result,callback) => {
			console.log('    NormalModuleFactory:resolver');	
			...
			resolver(result, (err, data) => {
				...
				console.log('    NormalModuleFactory:after-resolve');	
				this.hooks.afterResolve.callAsync(data, (err, result) => {
					if (err) return callback(err);

					// Ignored
					if (!result) return callback();
					console.log('    NormalModuleFactory:create-module');	
					...
					console.log('    NormalModuleFactory:module');	
	...
	create(data, callback) {
		...
		const contextInfo=data.contextInfo||{};
		console.log('    NormalModuleFactory:before-resolve');	
		this.hooks.beforeResolve.callAsync(
			...
			(err, result) => {
				...
				// Ignored
				if (!result) return callback();
				console.log('    NormalModuleFactory:factory');	
	...
	createParser(type, parserOptions = {}) {
		...
		console.log('    NormalModuleFactory:parser');	
	...
	createGenerator(type, generatorOptions = {}) {
		...
		console.log('    NormalModuleFactory:generator');	
